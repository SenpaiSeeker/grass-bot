...
class ProxyFetcher:
    def __init__(self, proxy_file):
        self.proxy_url = "https://api.proxyscrape.com/v4/free-proxy-list/get?request=display_proxies&proxy_format=protocolipport&format=text"
...
fetcher = ProxyFetcher("proxy.txt")
await fetcher.run()
